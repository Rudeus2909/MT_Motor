            ...
            onTap: () {
              Navigator.push(
                  ...
                  MaterialPageRoute<Widget>(
                      builder: (BuildContext context) => const ProHondaNewsScreen()));
            },
          ),
          ListTile(
            title: const NewsListView(
                thumbnail: 'assets/news/Top3Moto.jpg',
                title: '3 mẫu xe dưới 100 triệu đáng sở hữu nhất hiện nay',
                subtitle:
            ...
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (BuildContext context) => const Top3MotoScreen()));
            },
          ),
          ListTile(
            title: const NewsListView(
            ...
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (BuildContext context) => const PG1Screen()));
            },
          ),
          ListTile(
            title: const NewsListView(
            ...
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (BuildContext context) => const CB350Screen()));
            },
          ),
          ListTile(
            title: const NewsListView(
            ...
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (BuildContext context) => const WinnerV4Screen()));
            },
          ),
          ListTile(
            title: const NewsListView(
            ...
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (BuildContext context) => const SuzukiSaleScreen()));
            },
          ),
        ],
      ),
